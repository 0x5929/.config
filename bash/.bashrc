# SETUP: this file requires a couple of steps of setup!!!
# NOTE: this .bashrc file lives in a different location
#	this was done for centralizing all config files, and implementing version control.

# PLEASE, uncomment/put the following variable def, and if statement in the following locations
...
# running commands to adjust home monitor setup, done elsewhere now, with x?
